   ...
   {		
	...
	ECHO "<BR><BR><BR>";
		...
		<th>8</th>
			...
			echo "<br><br><a href=studtimetable.php><center>BACK</center></a>";	
...
<form name="myForm" method="post" action="studtimetable.php" onSubmit="return validate();">
		...
		<br><br>
		  ...
		  <a href="studtimetable.php"> <input type="button" value="CLEAR" align="center" style="color:black;" > </a>
		  </center>
