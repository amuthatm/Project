...
<form name="myForm" method="post" action="tview.php" align="center" size="40px" onSubmit="validateForm();">
<div class="tablerw" >
  ...
  <div class="tablerw">
   <br><br><br> 
  &nbsp;
  <input type="submit" value="GO" align="center" style="background-color:grey;color:black;">&nbsp;&nbsp;&nbsp;
