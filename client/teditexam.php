...
<form name="myForm" method="post" action="teditexam.php" onSubmit="return validate();">
		...
		<center> <strong>Subject</strong>&nbsp;&nbsp;
			<input type="text" name="subject" value=""  style="color:black"></center>	<br>
