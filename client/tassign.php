...
$result = mysqli_query($conn,"SELECT * FROM tbl_assignment");
...
echo "<td>" . $row['date'] . "</td>";
echo "<td>".'<a href="tassign.php?id1=' . $aid . '">Delete</a>'. "</td>";
echo "</tr>";
...
<?php 
		  ...
		  $result="DELETE FROM `tbl_assignment` WHERE ag_no ='$aid' ";
		//  $result ="INSERT INTO `tbl_exam` (`class`, `subject`, `date`) VALUES ('$class', '$sub', '$date')";
	
			
           if($conn->query($result)=="TRUE"){
	         //     echo "Added";
		  
		         header("Location: tassign.php");
