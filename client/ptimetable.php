   ...
   {		
	...
	ECHO "<BR><BR><BR>";
		...
		<th>8</th>
			...
			echo "<br><br><a href=ptimetable.php><center>BACK</center></a>";	
...
<form name="myForm" method="post" action="ptimetable.php" onSubmit="return validate();">
		...
		<br><br>
		  ...
		  <a href="ptimetable.php"> <input type="button" value="CLEAR" align="center" style="color:black;" > </a>
		  </center>
