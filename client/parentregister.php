...
<form name="pForm" method="post" action="parentAction.php" onSubmit="required validateForm();">
 ...
 <div class="tablerw">
  ...
  <h1 align="center"><font size=12px"> Registration Form</font></h1>
...
<div class="tablerw">
  ...
  <div class="tablecol">Name&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;

  <input type="text" name="pname" id="pname" size="30" style="background-color:white; color:black;" required ></div>
...
<br>
 ...
 <div class="tablerw">
  ...
  <div class="tablecol">Student ID&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;

   <input type="text" name="s_id" id="s_id" size="30" style="background-color:white; color:black;" required></div>
 ...
 <div class="tablerw">
  ...
  <div class="tablecol">Phone no&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;

   <input type="text" name="phone" id="phone" size="30" style="background-color:white; color:black;" required></div>
  ...
  <input type="email" name="pemail" id="pemail" size="30" style="background-color:white; color:black;" required></div>
  ...
  <div class="tablecol">Parent UserName&nbsp;&nbsp;&nbsp;&nbsp;

  <input type="text" name="p_uname" id="p_uname" size="30" style="background-color:white; color:black;" required></div>
...
<br>
  ...
  <div class="tablecol">Parent password&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;

  <input type="password" name="p_password" id="p_password" size="30" style="background-color:white; color:black;" required></div>

  </div>
  <br>
  <div class="tablerw">

  <div class="tablecol">Relation&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;

  <input type="text" name="relation" id="relation" size="30" style="background-color:white; color:black;" required></div>
 ...
 <a href="parentregister.php">  <input type="button" value="CLEAR" align="center" style="background-color:gray;color:black;" > </a>
