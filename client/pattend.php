...
<br><br><br>
 ...
 if ($conn->connect_error){
	 ...
	 die("connection failed :" .$conn->connect_error);
            ...
            $sql2="select attendance,date from tbl_attendance where s_id='$stud_id'";
			$res2=mysqli_query($conn,$sql2);
			if(mysqli_num_rows($res2)>0){
				echo "<h1><center>ATTENDANCE</center></h1>";
				while($row=mysqli_fetch_assoc($res2)){  
						echo "<br><br><center><strong>Attendence as on </strong>".$row['date'];	
						echo "&nbsp; :&nbsp;<strong>".$row['attendance']."%</strong></center>";
