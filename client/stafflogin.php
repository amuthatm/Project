...
<div class="form">
												...
												<form class="login"  name="myForm" method="post"  action="sloginAction.php" onSubmit="validateForm();">
												
							       <strong>   UserName</strong><input type='text' placeholder="enter username" name="s_username" required>
								...
								<div>
									...
									<br><br><br>
															...
															<a  href="index.php">    <input type='BUTTON'   name='back' value='BACK'></a>
																<p class="message">Not registered?<a href="staffregister.php">REGISTER</a></p>
															</div>	
